...
@Mod(modid = "floppahack", version = FloppaHack.FLOPPAHACK_VERSION, name = FloppaHack.FLOPPAHACK_NAME)
public class FloppaHack {

	@Mod.Instance
	private static FloppaHack MASTER;

	public static final String FLOPPAHACK_NAME = "floppaHack";
	public static final String FLOPPAHACK_VERSION = "b1.1";
	public static final String FLOPPAHACK_SIGN = " ";
	...
	public void WurstplusStarting(FMLInitializationEvent event) {
		...
		Display.setTitle(FloppaHack.FLOPPAHACK_NAME + " " + FloppaHack.FLOPPAHACK_VERSION);
	...
	public static String get_name() {
		return  FLOPPAHACK_NAME;
	}

	public static String get_version() {
		return FLOPPAHACK_VERSION;
	}
