...
public class WurstplusAutoNomadHut extends WurstplusHack {
    ...
    public WurstplusAutoNomadHut() {
        ...
        this.description = "builds you a house to groom childrens (cops can appear)";
    }

    WurstplusSetting rotate         = create("Fast Groom",           "NomadSmoth",       true);
	WurstplusSetting triggerable    = create("Toggle",			 "NomadToggle", 		true);
	WurstplusSetting tick_for_place = create("Groom Speed",	 "NomadTickToPlace", 2, 1, 8);
