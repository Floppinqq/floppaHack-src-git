...
public class PhobosAutoGG extends WurstplusHack {

    public PhobosAutoGG() {
        super(WurstplusCategory.WURSTPLUS_CHAT);

        this.name = "PhobosAutoGG";
        this.tag = "PAutoGG";
        this.description = "phobos 1.7.2 auto gg ezzzzz dump";
    }
    ...
    public void announce(String name) {
        ...
        if (custom.get_value(true)) {
            ...
            message +="<player> is a noob hahaha fobus on tope";
        }
