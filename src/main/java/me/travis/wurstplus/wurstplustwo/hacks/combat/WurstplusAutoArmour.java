...
public class WurstplusAutoArmour extends WurstplusHack {
    ...
    WurstplusSetting delay = create("Delay", "AADelay", 1, 0, 5);
    WurstplusSetting smart_mode = create("Smart Mode", "AASmartMode", false);
    WurstplusSetting put_back = create("Equip Armour", "AAEquipArmour", true);
    WurstplusSetting player_range = create("Player Range", "AAPlayerRange", 6, 0, 20);
    WurstplusSetting crystal_range = create("Crystal Range", "AACrystalRange", 9, 0, 20);
    WurstplusSetting boot_percent = create("Boot Percent", "AATBootPercent", 100, 0, 100);
    WurstplusSetting chest_percent = create("Chest Percent", "AATChestPercent", 100, 0, 100);
