...
public class WurstplusHack implements Listenable {
	...
	protected WurstplusSetting create(String name, String tag, int value, int min, int max) {
		FloppaHack.get_setting_manager().register(new WurstplusSetting(this, name, tag, value, min, max));

		return FloppaHack.get_setting_manager().get_setting_with_tag(this, tag);
	}
	...
	protected WurstplusSetting create(String name, String tag, boolean value) {
		FloppaHack.get_setting_manager().register(new WurstplusSetting(this, name, tag, value));
	...
	protected WurstplusSetting create(String name, String tag, String value, List<String> values) {
		FloppaHack.get_setting_manager().register(new WurstplusSetting(this, name, tag, values, value));
