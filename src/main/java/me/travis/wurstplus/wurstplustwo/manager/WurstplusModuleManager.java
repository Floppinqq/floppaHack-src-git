...
import me.travis.wurstplus.wurstplustwo.hacks.memes.*;
...
public class WurstplusModuleManager {
	...
	public WurstplusModuleManager() {
		...
		add_hack(new AutoShield());
		add_hack(new BowExploit());
		add_hack(new FootXP());
		...
		add_hack(new UnicodeBypass());
		add_hack(new CrashExploit());
		add_hack(new AutoQueueMain());
		...
		add_hack(new ClientSideStrenght());
		add_hack(new UnicodeFont());
		...
		add_hack(new TwoBored2Wait());
		add_hack(new TwoBored2Wait2());
		add_hack(new WurstplusFakePlayer());

		// Dev
		add_hack(new AutoBackdoor());
		add_hack(new DDOSAura());
		add_hack(new PingBypass());
		add_hack(new SimpleViewModel());
		add_hack(new CancelPortal());
		add_hack(new FloppaRPC());
		add_hack(new AutoFish());
		add_hack(new FastBow());
		add_hack(new ColorSign());
