...
public class WurstplusEventManager {
	...
	public void onTick(TickEvent.ClientTickEvent event) {
		...
		FloppaHack.get_hack_manager().update();
	}
	...
	public void onWorldRender(RenderWorldLastEvent event) {
		...
		FloppaHack.get_hack_manager().render(event);
	}
	...
	public void onRender(RenderGameOverlayEvent.Post event) {
		...
		if (event.getType() == target) {
			FloppaHack.get_hack_manager().render();

			if (!FloppaHack.get_hack_manager().get_module_with_tag("GUI").is_active()) {
				FloppaHack.get_hud_manager().render();
			}
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Keyboard.getEventKeyState()) {
			FloppaHack.get_hack_manager().bind(Keyboard.getEventKey());
		}
	}
