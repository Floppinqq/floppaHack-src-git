...
public class WurstplusPvpHud extends WurstplusPinnable {
	...
	public void render() {
        ...
        create_line(selftrap, this.docking(1, selftrap), 56, nl_r, nl_g, nl_b, nl_a);
    ...
    public String selftrap_enabled() {
        try {
            if (FloppaHack.get_hack_manager().get_module_with_tag("SelfTrap").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
    ...
    public String aura_enabled() {
        ...
        try {
            if (FloppaHack.get_hack_manager().get_module_with_tag("AutoCrystal").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
