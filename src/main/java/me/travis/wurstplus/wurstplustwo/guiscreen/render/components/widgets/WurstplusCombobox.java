...
public class WurstplusCombobox extends WurstplusAbstractWidget {
	...
	public WurstplusCombobox(WurstplusFrame frame, WurstplusModuleButton master, String tag, int update_postion) {
		...
		this.frame   = frame;
		this.master  = master;
		this.setting = FloppaHack.get_setting_manager().get_setting_with_tag(master.get_module(), tag);
	...
	public void render(int master_y, int separe, int absolute_x, int absolute_y) {
		...
		int ns_r = FloppaHack.click_gui.theme_widget_name_r;
		int ns_g = FloppaHack.click_gui.theme_widget_name_g;
		int ns_b = FloppaHack.click_gui.theme_widget_name_b;
		int ns_a = FloppaHack.click_gui.theme_widget_name_b;
