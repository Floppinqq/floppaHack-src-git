...
public class WurstplusModuleButton {
	...
	public WurstplusModuleButton(WurstplusHack module, WurstplusFrame master) {
		...
		for (WurstplusSetting settings : FloppaHack.get_setting_manager().get_settings_with_hack(module)) {
		...
		int size = FloppaHack.get_setting_manager().get_settings_with_hack(module).size();
	...
	public void render(int mx, int my, int separe) {
		...
		int nm_r = FloppaHack.click_gui.theme_widget_name_r;
		int nm_g = FloppaHack.click_gui.theme_widget_name_g;
		int nm_b = FloppaHack.click_gui.theme_widget_name_b;
		int nm_a = FloppaHack.click_gui.theme_widget_name_a;

		int bg_r = FloppaHack.click_gui.theme_widget_background_r;
		int bg_g = FloppaHack.click_gui.theme_widget_background_g;
		int bg_b = FloppaHack.click_gui.theme_widget_background_b;
		int bg_a = FloppaHack.click_gui.theme_widget_background_a;

		int bd_r = FloppaHack.click_gui.theme_widget_border_r;
		int bd_g = FloppaHack.click_gui.theme_widget_border_g;
		int bd_b = FloppaHack.click_gui.theme_widget_border_b;
