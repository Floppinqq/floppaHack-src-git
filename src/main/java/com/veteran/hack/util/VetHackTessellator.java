...
public class VetHackTessellator extends Tessellator
{
    public static VetHackTessellator INSTANCE;

    public VetHackTessellator() {
        super(2097152);
    }
    ...
    public static void begin(final int mode) {
        VetHackTessellator.INSTANCE.getBuffer().begin(mode, DefaultVertexFormats.POSITION_COLOR);
    }
    ...
    public static void render() {
        VetHackTessellator.INSTANCE.draw();
    }
    ...
    public static void drawBox(final double x, final double y, final double z, final int argb, final int sides) {
        ...
        final int g = argb >>> 8 & 0xFF;
        final int b = argb & 0xFF;
        drawBox(VetHackTessellator.INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawBoxSmall(final double x, final double y, final double z, final int argb, final int sides) {
        ...
        final int g = argb >>> 8 & 0xFF;
        final int b = argb & 0xFF;
        drawBox(VetHackTessellator.INSTANCE.getBuffer(), x, y, z, 0.25f, 0.25f, 0.25f, r, g, b, a, sides);
    }

    public static void drawBox(final BlockPos blockPos, final int r, final int g, final int b, final int a, final int sides) {
        drawBox(VetHackTessellator.INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }

    public static BufferBuilder getBufferBuilder() {
        return VetHackTessellator.INSTANCE.getBuffer();
    }
    ...
    static {
        VetHackTessellator.INSTANCE = new VetHackTessellator();
    }
}